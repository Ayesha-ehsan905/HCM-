...
export const WhyChooseUsSection = () => {
  return (
    <div className="container">
      <section
        className=" flex flex-col w-full items-center gap-6 lg:gap-16 my-[60px] lg:my-[240px]"
        id="resources"
      >
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          <h2 className="font-semibold text-[24px] lg:text-[40px] text-center tracking-[0] leading-normal lg:leading-[52px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="border-0 shadow-none bg-transparent max-w-[305px] "
            >
