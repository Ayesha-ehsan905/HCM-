...
export const FooterSection = () => {
  return (
    <section className="flex flex-col items-start gap-6 w-full max-w-[522px]">
      ...
      <Button className="bg-[#7b5ee0] hover:bg-[#6a4ec9] inline-flex items-center justify-center gap-2.5 px-4 py-3 rounded-[40px] h-auto">
