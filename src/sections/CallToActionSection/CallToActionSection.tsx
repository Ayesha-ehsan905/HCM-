...
export const CallToActionSection = () => {
  return (
    <section className="flex flex-col w-full items-center gap-16 py-16">
      <div className="flex flex-col items-center gap-4 w-full">
        ...
        <h2 className="font-semibold text-[40px] text-center tracking-[0] leading-[52px]">
          <span className="text-[#1a1a1a]">Why Companies Trust </span>
          <span className="text-[#7b5ee0]">HCM Strategy</span>
        </h2>
      </div>
        ...
        {features.map((feature, index) => (
          <Card key={index} className="border-0 shadow-none bg-transparent">
            <CardContent className="flex flex-col items-start gap-4 p-0">
              ...
              <h3 className="font-semibold text-[#1a1a1a] text-xl tracking-[0] leading-[26px]">
                {feature.title}
              </h3>
