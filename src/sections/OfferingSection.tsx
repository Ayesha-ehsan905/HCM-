...
export const OfferingSection = () => {
  return (
    <section className="relative w-full px-6 sm:px-10 lg:px-20 py-10 lg:py-16 bg-secondary/4 overflow-hidden mt-[120px] lg:mt-[310px]">
      {/* Background Blurs */}
      ...
      <div className="relative max-w-[1280px] mx-auto flex flex-col items-center gap-10 lg:gap-16">
        ...
        <div className="flex flex-col gap-8 w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-8 w-full">
            {/* Card 1 */}
            <Card className="flex-1 bg-white rounded-2xl border-0 shadow-none">
